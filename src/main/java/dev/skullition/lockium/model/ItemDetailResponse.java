 ...
 *
 * <ul>
 *   <li>{@code item} – the block as placed in the world
 *   <li>{@code seed} – the plantable seed form
 * </ul>
 *
 * <p>Both share the same structure ({@link GrowtopiaObject}); even items without a functional seed
 * return a placeholder seed object.
 *
